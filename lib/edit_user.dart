...
class EditUserScreenState extends State<EditUserScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        body: SizedBox(child: Builder(builder: (BuildContext contextscaffold) {
  ...
  actualizarContra() async {
    ...
    if (user_conectado.getContra() == contra.text) {
      ...
      await userUpdate.updateUser(
          user_conectado.id_doc, user_conectado.toMap());
  ...
  Widget informacion_user() {
    return Container(
      ...
      child: Column(
        children: [
          Row(
            children: [subtitle("Informacion de Usuario"), iconEdit()],
  ...
  Widget iconPassword() {
    return IconButton(
      icon: Icon(contra_invisible ? Icons.visibility : Icons.visibility_off),
  ...
  Widget container_password() {
    return Container(
      ...
      child: Column(
        children: [
          Row(
            children: [subtitle("Cambio de Contraseña"), iconPassword()],
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
          ),
          ...
          Row(
            ...
            children: [
              BottomGreen(50, MediaQuery.of(context).size.width * 0.4,
                  "Cambiar Contraseña", cambiarContra),
            ],
          ),
          espacio_vertical(5),
        ],
  ...
  Widget password(
      String valor, String dato, TextEditingController controlador) {
    return TextFormField(
      validator: (value) {
